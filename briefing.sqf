...
player createDiarySubject ["details","Server Details"];
player createDiarySubject ["law","LAWS for DU"];
...
<br/>
- Hacking/Exploiting in any way shape or form and distributing throughout the community is not permitted on DownUnder Servers.<br/>
...
- In DownUnder Roll Play Is Required in all aspects of game play, if you believe you downloaded the latest shoot’em’up Mod for Arma2 you have been terribly mistaken.<br/>
<br/>
...
"
<br/>
ts3.downundermod.com Port:9987<br/>
<br/>
